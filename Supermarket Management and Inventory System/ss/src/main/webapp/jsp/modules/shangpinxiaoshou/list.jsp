...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">商品销售管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>商品销售管理</span></li>
				<li class="breadcrumb-item-two"><span>商品销售列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('销量统计')"><i class="fa fa-database"></i><span>销量统计</span></button>
			</div>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('xiaoshoudanhao')">销售单号<i id="xiaoshoudanhaoIcon" class="fa fa-sort"></i></th>
						...
						<th onclick="sort('xiaoshoushijian')">销售时间<i id="xiaoshoushijianIcon" class="fa fa-sort"></i></th>
            ...
            <div class="openBox" v-if="showType1">
                ...
                <div class="openView">
                    <div id="shuliangMain1" class="graph" style="width: 70vw;height:50vh;"></div>
                </div>
            </div>
		</div>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xiaoshoudanhaoCell  = document.createElement('td');

						 xiaoshoudanhaoCell.innerHTML = item.xiaoshoudanhao;

			row.appendChild(xiaoshoudanhaoCell);
			...
			var xiaoshoushijianCell  = document.createElement('td');

						  xiaoshoushijianCell.innerHTML = item.xiaoshoushijian;


			row.appendChild(xiaoshoushijianCell);
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.location.href = url;
                ...
                function chartDialog1(){
                    ...
                    $.ajax({
                        type: "GET",
                        url: baseUrl+`shangpinxiaoshou/value/shangpinmingcheng/shuliang`,
                        ...
                        success: function(data){
                            if(data.code == 0){
                                if(data.data != null){
                                    ...
                                    var myChart = echarts.init(document.getElementById('shuliangMain1'),'macarons');
                                    var option = {};
                                    option = {
                                        title: {
                                            text: '销量统计',
