...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">经理管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>经理管理</span></li>
				<li class="breadcrumb-item-two"><span>经理列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>经理账号</label>
					<input type="text" id="jinglizhanghaoSearch" class="form-control form-control-sm" placeholder="请输入经理账号" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>经理姓名</label>
					<input type="text" id="jinglixingmingSearch" class="form-control form-control-sm" placeholder="请输入经理姓名" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#jinglizhanghaoSearch').val() != null && $('#jinglizhanghaoSearch').val() != ''){
				searchForm.jinglizhanghao ="%" +  $('#jinglizhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("jingli/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				jinglizhanghao : searchForm.jinglizhanghao,	
