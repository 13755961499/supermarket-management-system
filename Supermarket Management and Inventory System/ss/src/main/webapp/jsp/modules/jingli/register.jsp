...
<div class="content">
	<form id="registerForm" action="" method="post">
		<div class="title">经理注册</div>
		<div class="list-item">
			<input  name="jinglizhanghao"  placeholder="请输入经理账号" class="form-control-i">
		</div>
		<div class="list-item">
			<input  name="jinglixingming"  placeholder="请输入经理姓名" class="form-control-i">
		</div>
		<div class="list-item">
		...
		<div class="list-item">
			<input  name="dianhuahaoma"  placeholder="请输入电话号码" class="form-control-i">
		</div>
...
<script type="text/javascript">
	...
	function submit() {
		if(validform() ==true){
			...
			var url = baseUrl + "jingli/register";
			$.ajax({
				type: "POST",
				url: url,
