...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">缺货提醒管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>缺货提醒管理</span></li>
				<li class="breadcrumb-item-two"><span>缺货提醒列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('tixingbianhao')">提醒编号<i id="tixingbianhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var tixingbianhaoCell  = document.createElement('td');

						 tixingbianhaoCell.innerHTML = item.tixingbianhao;

			row.appendChild(tixingbianhaoCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("quehuotixing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("quehuotixing"+colName,"GET",{
			tableName: "quehuotixing",
			columnName: colName
		},(res)=>{
			if(res.code == 0){
				return res.data.sum;
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"quehuotixing");
